    ...
    public void init() {
        try {
            ...
            if (hasFacilities) {
                ...
                // Prices
                facility1.setPrice(20.0f);
                facility2.setPrice(15.0f);
                facility3.setPrice(10.0f);
                facility4.setPrice(12.0f);
                facility5.setPrice(25.0f);
                facility6.setPrice(30.0f);
            ...
            if (hasClasses) {
                ...
                //Prices
                class1.setPrice(20.0f);
                class2.setPrice(15.0f);
                class3.setPrice(10.0f);
                class4.setPrice(12.0f);
                class5.setPrice(25.0f);
                class6.setPrice(30.0f);
